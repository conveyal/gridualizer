 ...
 */
var DitherColorizer = function DitherColorizer(breaks, colors) {
  var baseColorizer = (0, _choropleth2.default)(breaks, colors);
  return function (value) {
    var rand = gaussianApproximation(2, 2, 1);
 ...
 */
var gaussianApproximation = function gaussianApproximation(iterations, width, mean) {
  var sum = 0;
...
exports.default = DitherColorizer;
module.exports = exports['default'];

//# sourceMappingURL=dither.js