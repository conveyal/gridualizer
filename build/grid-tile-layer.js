...
var GridTileLayer = function (_TileLayer$Canvas) {
  (0, _inherits3.default)(GridTileLayer, _TileLayer$Canvas);

  function GridTileLayer() {
    (0, _classCallCheck3.default)(this, GridTileLayer);
    return (0, _possibleConstructorReturn3.default)(this, (GridTileLayer.__proto__ || (0, _getPrototypeOf2.default)(GridTileLayer)).apply(this, arguments));
  }

  (0, _createClass3.default)(GridTileLayer, [{
    key: 'initialize',
    value: function initialize(grid, interpolator, colorizer) {
      this.grid = grid;
      this.interpolator = interpolator;
      this.colorizer = colorizer;
      // Find a maximum with outliers trimmed off only when needed, because it can take some time.
      if (colorizer.normalize === true) this.trimmedMax = (0, _util.getTrimmedMax)(grid);
    }
    ...
    value: function drawTile(canvas, mercTileCoord, zoom) {
      ...
      var dilutionFactor = this.trimmedMax;
      ...
      var interpolator = this.interpolator === null || zoomDifference <= 1 || zoomDifference > 8 ? _nearest2.default : this.interpolator;
      ...
      var gridOffset = this.interpolator.gridOffset;
      var gxMin = Math.floor(mercPixelX / gridCellWidthInTilePixels - this.grid.west - gridOffset);
      var gyMin = Math.floor(mercPixelY / gridCellWidthInTilePixels - this.grid.north - gridOffset);
      ...
      for (var gx = gxMin; gx < gxMax; gx += gridStep) {
        for (var gy = gyMin; gy < gyMax; gy += gridStep) {
          var patch = interpolator(this.grid, gx | 0, gy | 0);
          ...
          for (var ty = tyMin; ty < tyMax; ty++) {
            ...
            for (var tx = txMin; tx < txMax; tx++) {
              ...
              var color = this.colorizer(interpolatedValue);
              if (color[3] !== 0) {
...
exports.default = GridTileLayer;
module.exports = exports['default'];

//# sourceMappingURL=grid-tile-layer.js