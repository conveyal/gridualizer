...
import ckmeans from './classifiers/ckmeans'
...
import dot from './colorizers/dot.js'
...
import spline from './interpolators/spline'

export const GridTileLayer = GridTileLayerp
export const ReactGridMapLayer = ReactGridMapLayerp
export const classifiers = { equal, quantile, diverging, ckmeans }
export const colorizers = { dither, choropleth, gradient, dot }
export const interpolators = { bicubic, bilinear, nearest, spline }
